    ...
    size_t num_threads)
{
  ...
  if (compressed_input1_shape[0] == 1) {
    binary_elementwise_op->context.elementwise_binary.ukernel = vbinary->minmax_ropc_ukernel;
    ...
    binary_elementwise_op->context.elementwise_binary.ukernel = vbinary->minmax_opc_ukernel;
  } else if (compressed_input1_shape[0] == compressed_input2_shape[0]) {
    binary_elementwise_op->context.elementwise_binary.ukernel = vbinary->minmax_op_ukernel;
  }
